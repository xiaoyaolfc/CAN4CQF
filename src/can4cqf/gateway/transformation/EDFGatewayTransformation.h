...
#ifndef __CAN4CQF_EDFGatewayTransformation_H_
#define __CAN4CQF_EDFGatewayTransformation_H_
 ...
 * @brief 使用EDF
 */
class EDFGatewayTransformation : public cSimpleModule
{
  public:
    EDFGatewayTransformation();
  protected:
