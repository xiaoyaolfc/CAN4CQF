...
#ifndef __CAN4CQF_IEEE8021QCHGATECONTROLLIST_H_
#define __CAN4CQF_IEEE8021QCHGATECONTROLLIST_H_
 ...
 */
class IEEE8021QchGateControlList : public virtual Scheduled
{
  protected:
    /**
